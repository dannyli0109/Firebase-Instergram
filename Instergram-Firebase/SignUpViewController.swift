...
//  Instergram-Firebase
//
//  Created by Xiaohao Li on 2017/4/1.
...
class SignUpViewController: UIViewController, UIImagePickerControllerDelegate, UINavigationControllerDelegate {
    ...
    let alreadyHaveAccountButton: UIButton = {
        ...
        attributedTitle.append(NSAttributedString(string: "Sign In", attributes: [NSFontAttributeName: UIFont.boldSystemFont(ofSize: 14), NSForegroundColorAttributeName: UIColor.rgb(17, 154, 237)]))
